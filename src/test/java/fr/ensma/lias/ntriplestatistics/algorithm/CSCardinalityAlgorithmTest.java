...
public class CSCardinalityAlgorithmTest {
	...
	public void buildAsTextFromTabContentTest() {
		...
		// When
		ICardinalityAlgorithmBuilder builder = new CSCardinalityAlgorithm.CSCardinalityAlgorithmBuilder(inputFiles);
	...
	public void buildAsCSTest() {
		...
		// When
		ICardinalityAlgorithmBuilder builder = new CSCardinalityAlgorithm.CSCardinalityAlgorithmBuilder(inputFiles);
		List<CharacteristicSet> buildAsCS = ((CSCardinalityAlgorithm.CSCardinalityAlgorithmBuilder) builder)
				.buildAsCS();
